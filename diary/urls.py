...
urlpatterns = [
    ...
    # path('sukashi-list/', views.SukashiListView.as_view(), name="sukashi_list"),
    path('sukashi-list/', views.SukashiFList.as_view(), name="sukashi_list"),
    ...
    # path('sukashi-f-list/', views.SukashiFList.as_view(), name="sukashi_f_list"),
]
